...
public class MyActivity extends Activity {
    ...
    private void initVideoView() {
            ...
            public void onPrepared(MediaPlayer mp) {
                videoSliceSeekBar.setSeekBarChangeListener(new VideoSliceSeekBar.SeekBarChangeListener() {
                    ...
                    public void SeekBarValueChanged(int leftThumb, int rightThumb) {
                        ...
                        Toast.makeText(getApplicationContext(), "Minimum: " + leftThumb + "Maximum: " + rightThumb,  Toast.LENGTH_SHORT).show();
        ...
        videoView.setVideoURI(Uri.parse("android.resource://com.example.TrellWork/" + R.raw.video));
    }
